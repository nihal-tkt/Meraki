...
function Eyes() {
  ...
  return (
    <div className="eyes w-full h-[200px] md:h-[600px] overflow-hidden ">
      <div
        data-scroll
        data-scroll-section
        data-scroll-speed="-0.5"
        className="w-full relative h-[300px] sm:h-screen bg-zinc-900 bg-cover bg-center bg-[url('/projectImg/myBackgroundImage.jpg')] "
      >
